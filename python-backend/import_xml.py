...
xml_file_path = os.path.join(current_dir, "temp_timeline_export2.xml")
...
timeline_from_xml = mediapool.ImportTimelineFromFile(
    xml_file_path, {"timelineName": "Imported Timeline via Script API"}
)
print(f"Timeline from XML: {timeline_from_xml}")
