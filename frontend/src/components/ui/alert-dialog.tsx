...
function AlertDialogContent({
  ...
  ...props
}: React.ComponentProps<typeof AlertDialogPrimitive.Content> & { disableRadixAnimations?: boolean }) {
  return (
    <AlertDialogPortal>
      <AlertDialogOverlay />
      <AlertDialogPrimitive.Content
        ...
        className={cn(
          ...
          {
            "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95": !disableRadixAnimations,
          },
