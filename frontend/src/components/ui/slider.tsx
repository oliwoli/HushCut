    ...
    <div className="relative px-0 py-2 h-full">
      ...
      >
        ...
        <SliderPrimitive.Thumb
          ...
          className="border-zinc-900 border-2 transition-[color,box-shadow] bg-zinc-200 block shrink-0 rounded-full focus-visible:outline-hidden disabled:pointer-events-none disabled:opacity-50 size-4 z-10 overflow-hidden group" // Ensure thumb is on top
        >
