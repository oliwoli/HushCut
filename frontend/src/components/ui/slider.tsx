    ...
    <div className="relative px-0 py-2 h-full">
      ...
      >
        ...
        <SliderPrimitive.Thumb
          ...
          className="border-zinc-400 transition-[color,box-shadow] border-t-zinc-300 border-b-zinc-400 border-b-2 bg-zinc-200 block size-4 shrink-0 rounded-[3px] border focus-visible:outline-hidden disabled:pointer-events-none disabled:opacity-50 w-4 h-7 z-10 overflow-hidden group" // Ensure thumb is on top
        >
          <div className="absolute top-1/2 left-1/2 -translate-y-1/2 h-[80%] rounded-[1px] w-[8px] bg-zinc-100 shadow-2xl pointer-events-none transform -translate-x-1/2 z-1 blur-[1px]" />
