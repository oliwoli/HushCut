...
import { Settings, Lock, Unlock, Scissors, RotateCcw, Link, Unlink } from 'lucide-react';
  ...
  return (
    <div className="h-screen p-6 bg-[#28282e]">
      <header className="flex items-center justify-between">
        ...
        <Button size="icon" className='hover:bg-zinc-600/20 bg-transparent hover:text-white'>
      ...
      <main className="flex-1 gap-8 mt-8">
        <div className="flex flex-col space-y-8">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-zinc-500">Set the threshold for silence detection.</p>
            <div className="flex items-center space-x-2">
              <Slider
                ...
                className="w-64"
              />
              <span className="text-sm text-zinc-100 text-nowrap">{threshold} dB</span>
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-zinc-500">Silence longer than this will be cut.</p>
            <div className="flex items-center space-x-2">
              <Slider
                min={0}
                max={5}
                ...
                className="w-64"
              />
              <span className="text-sm text-zinc-100">{minDuration.toFixed(3)}s</span>
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-zinc-500">Extend clips before cutting.</p>
            <div className="flex items-start space-x-6">
              ...
              <div className="flex flex-col space-y-1 w-64">
                <div className="flex items-center space-x-2">
                  ...
                  <Button
                    ...
                    className="text-zinc-500 hover:text-zinc-300"
                  >
                    {paddingLocked ? <Link className="h-2 w-2 ml-4" /> : <Unlink className="h-2 w-2 ml-4" />}
                  </Button>
                </div>
                <span className="text-sm text-zinc-400">Left:  <span className='text-zinc-100'>{paddingLeft.toFixed(2)}s</span></span>
              </div>
              ...
              <div className="flex flex-col space-y-1 w-64">
                ...
                <span className="text-sm text-zinc-400">Right: <span className='text-zinc-100'>{paddingRight.toFixed(2)}s</span></span>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-2">
            <Checkbox
              ...
              onCheckedChange={checked => setMakeNewTimeline(checked === true)}
            />
